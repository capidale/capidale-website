<template>
  <div class="relative flex flex-col-reverse space-y-4 space-y-reverse lg:space-y-0">
    <div>
      <img class="object-cover w-full h-56 rounded-lg shadow-md sm:h-72 lg:h-108" src="~/assets/img/hero.jpg" alt />
    </div>
    <div class="lg:absolute lg:inset-0 lg:flex lg:items-center lg:px-8">
      <div>
        <h2>
          <span
            class="block text-3xl font-extrabold text-center text-cool-gray-900 sm:text-4xl lg:text-left lg:text-lime-100">Since
            2011, we have raised</span>
          <span
            ...
            <ICountUp :delay="delay" :end-val="endVal" :options="options" @ready="onReady" />
          </span>
        </h2>
        <p
          ...
          <span class="font-bold text-lime-600 lg:text-white">evaluation expertise</span>
